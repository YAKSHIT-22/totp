...
const ModalContainer = ({ heading, children, isOpen, isCta, onClose, cta, formid, onSubmit, ctaClass, scrollBehavior = "", modalClass = "", enableFooter = true }) => {
      ...
      <ModalContent>
        {(onClose) => (
          <>
            ...
            {isCta === true && (formid ? (enableFooter && <Button form={formid} type='submit' color={ctaClass}>
                {cta}
